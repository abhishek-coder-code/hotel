...
const RomsCard = ({room}) => {
    ...
    return (
        <motion.div
            ...
            <div className='rounded-xl shadow-xl overflow-hidden transition-transform duration-200 ease-out md:max-w-80 bg-white px-2 md:px-5'>
